---
title: "Overview"
description: "Faseeh - First True Arabic Voice AI AI that speaks Dialects From Abu Dhabi to Rabat with Voice Cloning & On-prem support "
---

## Faseeh Text To Speech API

Create an API Key in faseeh dashboard to get started
